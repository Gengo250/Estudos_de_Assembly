...
main proc
    ...
    mov bx, 1234h           ; Valor hexadecimal a ser exibido (corrigido)
    mov cx, 4               ; 16 bits = 4 nibbles

next_digit:
    mov dx, bx              ; Copia BX para DX
    and dx, 0F000h          ; Mascara os 4 bits mais significativos
    shr dx, 12              ; Desloca para a direita 12 bits para deixar o nibble no final
