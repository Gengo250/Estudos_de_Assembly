...
XOR BX, BX ; Zera o registrador BX (vai ser usado como índice para a manipulação do vetor)

VOLTA: ; Loop para a manipulação do vetor

MOV DL, VETOR[BX] ; Copia o valor armazenado do índice BX para DL (inicialmente 0)
